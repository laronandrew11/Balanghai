...
function createShipDetailsPanel(ship){
	...
	pnlDetails.addLabel(new Label(100,100,100,25,"Name: "+ship.properName,"Epistolar",15,"black"));
	pnlDetails.addLabel(new Label(100,150,100,25,"Type: "+ship.name,"Epistolar",15,"black"));
	pnlDetails.addLabel(new Label(100,200,100,25,"Hull strength: "+ship.health,"Epistolar",15,"black"));
	pnlDetails.addLabel(new Label(100,250,100,25,"Speed: "+ship.speed,"Epistolar",15,"black"));
	pnlDetails.addLabel(new Label(100,300,100,25,"Cargo capacity: "+ship.cargoCapacity,"Epistolar",15,"black"));
...
function populateShipMenu(parentMenu)
{
	...
	for(i=0;i<gameState.ships.length;i++){
		...
		var newButton=new Button(gameState.ships[i].properName,x,470,140,140,item.properName,"Epistolar",15,"black", shipButtonBG);
